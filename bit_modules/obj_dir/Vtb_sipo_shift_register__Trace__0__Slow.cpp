...
VL_ATTR_COLD void Vtb_sipo_shift_register___024root__trace_init_sub__TOP__0(Vtb_sipo_shift_register___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBit(c+7,0,"nRST",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+8,0,"shift_enable",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+9,0,"serial_in",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+11,0,"test_data",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->declBit(c+8,0,"shift_enable",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+9,0,"serial_in",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+4,0,"tmp",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
...
VL_ATTR_COLD void Vtb_sipo_shift_register___024root__trace_const_0_sub_0(Vtb_sipo_shift_register___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+11,(0xb6U),8);
}
...
VL_ATTR_COLD void Vtb_sipo_shift_register___024root__trace_full_0_sub_0(Vtb_sipo_shift_register___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+4,(vlSelfRef.tb_sipo_shift_register__DOT__DUT__DOT__unnamedblk1__DOT__tmp),8);
    bufp->fullIData(oldp+5,(vlSelfRef.tb_sipo_shift_register__DOT__DUT__DOT__unnamedblk1__DOT__unnamedblk2__DOT__i),32);
    bufp->fullBit(oldp+6,(vlSelfRef.tb_sipo_shift_register__DOT__CLK));
    bufp->fullBit(oldp+7,(vlSelfRef.tb_sipo_shift_register__DOT__nRST));
    bufp->fullBit(oldp+8,(vlSelfRef.tb_sipo_shift_register__DOT__shift_enable));
    bufp->fullBit(oldp+9,(vlSelfRef.tb_sipo_shift_register__DOT__serial_in));
    bufp->fullIData(oldp+10,(vlSelfRef.tb_sipo_shift_register__DOT__unnamedblk1__DOT__i),32);
}
