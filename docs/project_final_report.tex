...
Numerous pieces of software were used to help develop this project, along with multiple programming languages. The names of the products used, along with their purpose in the project, are listed below.
...
\begin{table}[htp]
    ...
    \begin{tabular}{ |l|l|l| } 
        ...
        \hline
        \multirow{7}{6em}{Software} & Google Docs & Research and documentation \\
        & Figma & Brainstorming and drafting diagrams \\ 
        & Draw.io & Creating diagrams and flowcharts \\ 
        & Google Slides & Slideshow software that the Final Presentation was created in \\ 
        & Visual Studio Code & Programming IDE used for coding the project \\
        & Github & Site where project was hosted and shared \\ 
        ...
        & C++ & Language used for running SystemVerilog \\
        & Makefile & Language used for running SystemVerilog \\
...
We set out to have an even division of labor, and we ended up meeting that goal. The majority of the project (research, planning, and testing) was done during group work sessions, which helped with keeping contribution even. For the initial coding of all of the blocks, each person was assigned different files from the RTL diagram in Figure~\ref{fig:rtl} to implement and test. A more detailed illustration of our division of labor and design flow is shown in Figure~\ref{fig:dol}.
...
We kept our project to a pretty strict timeline shown below, though additional time and effort was spent in research as well as coding and testing the USB transceiver. We had multiple credible resources to reference by the end of week three, but making an RTL diagram required us to continue further research until a preimiliary design was agreed upon around week five. During coding, our RTL design was refined further while testing our modules took extra time as well.
\begin{figure}[H]
\centering
\begin{tikzpicture}
\draw (0,0) -- (0,9/1.5);
...
\draw (0,.5/1.5) node[minimum height=.9cm/1.5, minimum width =5cm,right=6pt, fill =gray!30, draw=gray!80] {\small Presentation and Paper Creation};
...
\paragraph{Leo:} Project based learning allowed to me to learn more about the practical uses of SystemVerilog, which has in turn made me a lot more interested in digital design. Our projcet scope was simulating a digital interface, but full USB implementation depends on analog design to send the data packets through physical wires. I read a lot about this when looking at the USB 2.0 documentation, and I have gained new interest in exploring analog design.
\paragraph{Nhan:}
