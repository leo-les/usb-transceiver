...
\begin{figure}[htp]
    \centering
    \includegraphics[width=11cm]{DOL}
...
\draw (0,0) node[left=3pt] {End};

\draw (0,1) node[left=3pt] {Week 8};
\draw (0,2) node[left=3pt] {Week 7};
\draw (0,3) node[left=3pt] {Week 6};
\draw (0,4) node[left=3pt] {Week 5};
\draw (0,5) node[left=3pt] {Week 4};
\draw (0,6) node[left=3pt] {Week 3};
\draw (0,7) node[left=3pt] {Week 2};
\draw (0,8) node[left=3pt] {Week 1};
\draw (0,9) node[left=3pt] {Week 0};

\draw (0,8.5) node[minimum height=1cm,minimum width =6cm,right=6pt, fill=red!30] {Project Proposal Drafting};
\draw (0,7) node[minimum height=2cm,minimum width =6cm,right=6pt, fill =orange!30] {Research};
\draw (0,5) node[minimum height=2cm, minimum width =6cm,right=6pt, fill =yellow!30] {Diagramming and Planning};
\draw (0,2.5) node[minimum height=3cm, minimum width =6cm,right=6pt, fill =green!30] {Coding and Testing};
\draw (0,.5) node[minimum height=1cm, minimum width =6cm,right=6pt, fill =gray!30] {Presentation and Paper Creation};
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=10cm]{docs/images/nrzi_stuffing.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=12cm]{docs/images/sim_tx_sync.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=12cm]{docs/images/sim_tx_00010101.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=12cm]{docs/images/sim_tx_01111111.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=12cm]{docs/images/sim_rx_01010101.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=12cm]{docs/images/sim_rx_11111101.png}
